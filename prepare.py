...
def prep_env():
    ...
    parser.add_argument('--train_size', type=int, default=185, help='Number of days for training')
    parser.add_argument('--val_size', type=int, default=30, help='Number of days for validation')
    parser.add_argument('--test_size', type=int, default=30, help='Number of days for testing')
    ...
    parser.add_argument('--batch_size', type=int, default=1024, help='Batch size for the input training data')
    parser.add_argument('--patience', type=int, default=3, help='Early stopping patience')
    parser.add_argument('--lr', type=float, default=1e-4, help='Optimizer learning rate')
    parser.add_argument('--lr_adjust', type=str, default='fixed', help='fixed: lr is fixed, rlrop: ReduceLROnPlateau')
    ...
    parser.add_argument('--capacity', type=int, default=50, help="The capacity of a wind farm, "
    ...
    parser.add_argument('--is_debug', type=bool, default=True, help='True or False')
