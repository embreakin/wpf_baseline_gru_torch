...
def prep_env():
    ...
    parser.add_argument('--num_workers', type=int, default=15, help='#workers for data loader')
    parser.add_argument('--train_epochs', type=int, default=10, help='Train epochs')
    # parser.add_argument('--batch_size', type=int, default=32, help='Batch size for the input training data')
    parser.add_argument('--batch_size', type=int, default=2048, help='Batch size for the input training data')
